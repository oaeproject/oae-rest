...
import { performRestRequest } from './util.js';
...
const getWidgetManifests = (restCtx, callback) => {
  doRequest(restCtx, '/api/ui/widgets', HTTP_GET, null, callback);
};
...
const getStaticBatch = (restCtx, files, callback) => {
  ...
  doRequest(restCtx, '/api/ui/staticbatch', HTTP_GET, { files }, callback);
};
...
const getSkin = (restCtx, callback) => {
  doRequest(restCtx, '/api/ui/skin', HTTP_GET, null, callback);
};
...
const getLogo = (restCtx, callback) => {
  doRequest(restCtx, '/api/ui/logo', HTTP_GET, null, callback);
};
...
const getSkinVariables = (restCtx, tenantAlias, callback) => {
  doRequest(restCtx, '/api/ui/skin/variables', HTTP_GET, { tenant: tenantAlias }, callback);
};
...
const uploadLogo = (restCtx, file, tenantAlias, callback) => {
  ...
  doRequest(restCtx, '/api/ui/skin/logo', HTTP_POST, parameters, callback);
};
