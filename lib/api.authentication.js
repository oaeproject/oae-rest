 ...
 */
var login = (module.exports.login = function(
    restCtx,
    username,
    password,
    callback,
 ...
 * @param  {Object}         callback.err    Error object containing error code and error message
 */
var existsOnTenant = (module.exports.existsOnTenant = function(
    restCtx,
    tenantAlias,
    username,
    callback,
 ...
 */
var twitterRedirect = (module.exports.twitterRedirect = function(
    restCtx,
    callback,
) {
 ...
 * @param  {Object}         callback.response   The HTTP response object
 */
var twitterCallback = (module.exports.twitterCallback = function(
    restCtx,
    params,
    callback,
) {
 ...
 * @param  {Object}         callback.response   The HTTP response object
 */
var facebookRedirect = (module.exports.facebookRedirect = function(
    restCtx,
    callback,
) {
 ...
 * @param  {Object}         callback.response   The HTTP response object
 */
var facebookCallback = (module.exports.facebookCallback = function(
    restCtx,
    params,
    callback,
) {
 ...
 * @param  {Object}         callback.response   The HTTP response object
 */
var googleRedirect = (module.exports.googleRedirect = function(
    restCtx,
    callback,
) {
 ...
 * @param  {Object}         callback.response   The HTTP response object
 */
var googleCallback = (module.exports.googleCallback = function(
    restCtx,
    params,
    callback,
) {
 ...
 * @param  {Object}         callback.response   The HTTP response object
 */
var casCallback = (module.exports.casCallback = function(
    restCtx,
    params,
    callback,
) {
 ...
 * @param  {Object}         callback.response   The HTTP response object
 */
var shibbolethTenantRedirect = (module.exports.shibbolethTenantRedirect = function(
    restCtx,
    redirectUrl,
    callback,
) {
 ...
 * @param  {Object}         callback.response       The HTTP response object
 */
var shibbolethSPRedirect = (module.exports.shibbolethSPRedirect = function(
    restCtx,
    params,
    callback,
) {
 ...
 * @param  {Object}         callback.response   The HTTP response object
 */
var shibbolethSPCallback = (module.exports.shibbolethSPCallback = function(
    restCtx,
    attributes,
    callback,
) {
    ...
    RestUtil.RestRequest(
        restCtx,
        '/api/auth/shibboleth/sp/callback',
        'GET',
        null,
        function() {
 ...
 * @param  {Object}         callback.response   The HTTP response object
 */
var shibbolethTenantCallback = (module.exports.shibbolethTenantCallback = function(
    restCtx,
    params,
    callback,
) {
 ...
 */
var ldapLogin = (module.exports.ldapLogin = function(
    restCtx,
    username,
    password,
    callback,
...
var resetPassword = (module.exports.resetPassword = function(
    ...
    RestUtil.RestRequest(
        ...
        'POST',
        { secret: secret, newPassword: newPassword },
        callback,
    );
});
