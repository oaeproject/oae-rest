 ...
 */
var getGroupMembers = (module.exports.getGroupMembers = function(
    restCtx,
    groupId,
    start,
    limit,
 ...
 * @param  {Object}         callback.err        An error that occurred, if any
 */
var joinGroup = (module.exports.joinGroup = function(
    restCtx,
    groupId,
    callback,
) {
 ...
 * @param  {Object}         callback.err        An error that occurred, if any
 */
var leaveGroup = (module.exports.leaveGroup = function(
    restCtx,
    groupId,
    callback,
) {
