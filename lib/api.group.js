...
const createGroup = (restCtx, displayName, description, visibility, joinable, managers, members, callback) => {
  ...
  RestUtil.performRestRequest(restCtx, '/api/group/create', 'POST', postData, callback);
};
...
const getGroup = (restCtx, groupId, callback) => {
  RestUtil.performRestRequest(restCtx, '/api/group/' + RestUtil.encodeURIComponent(groupId), 'GET', null, callback);
};
 ...
 */
const createRequestJoinGroup = function(restCtx, groupId, callback) {
  RestUtil.performRestRequest(
    restCtx,
 ...
 * @param  {Function}       callback        Invoked when the mapping has been verified
 */
const getJoinGroupRequest = function(restCtx, groupId, callback) {
  RestUtil.performRestRequest(
    restCtx,
 ...
 * @param  {Function}       callback        Invoked when the mapping has been verified
 */
const getJoinGroupRequests = function(restCtx, groupId, callback) {
  const params = {
    start: null,
    limit: null
  };
 ...
 * @param  {Function}       callback        Invoked when the mapping has been verified
 */
const updateJoinGroupByRequest = function(restCtx, joinRequest, callback) {
