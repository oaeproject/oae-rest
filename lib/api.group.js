 ...
 */
var createRequestJoinGroup = module.exports.createRequestJoinGroup = function(restCtx, groupId, callback) {
    RestUtil.RestRequest(restCtx, '/api/group/' + RestUtil.encodeURIComponent(groupId) + '/join-request', 'POST', null, callback);
};
 ...
 * @param  {Function}       callback        Invoked when the mapping has been verified
 */
var getJoinGroupRequest = module.exports.getJoinGroupRequest = function(restCtx, groupId, callback) {
    RestUtil.RestRequest(restCtx, '/api/group/' + RestUtil.encodeURIComponent(groupId) + '/join-request/mine', 'GET', null, callback);
};
 ...
 * @param  {Function}       callback        Invoked when the mapping has been verified
 */
var getJoinGroupRequests = module.exports.getJoinGroupRequests = function(restCtx, groupId, callback) {
    var params = {
        'start': null,
        'limit': null
    };
    RestUtil.RestRequest(restCtx, '/api/group/' + RestUtil.encodeURIComponent(groupId) + '/join-request/all', 'GET', params, callback);
};
 ...
 * @param  {Function}       callback        Invoked when the mapping has been verified
 */
var updateJoinGroupByRequest = module.exports.updateJoinGroupByRequest = function(restCtx, groupId, principalId, role, status, callback) {
    var params = {
        'principalId': principalId,
        'role': role,
        'status': status
    };
    RestUtil.RestRequest(restCtx, '/api/group/' + RestUtil.encodeURIComponent(groupId) + '/join-request', 'PUT', params, callback);
};
