...
const getInvitations = (restCtx, resourceType, resourceId, callback) => {
  ...
  RestUtil.performRestRequest(restCtx, `/api/${resourceType}/${resourceId}/invitations`, HTTP_GET, null, callback);
};
...
const acceptInvitation = (restCtx, token, callback) => {
  RestUtil.performRestRequest(restCtx, '/api/invitation/accept', HTTP_POST, { token }, callback);
};
