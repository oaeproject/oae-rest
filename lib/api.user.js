 ...
 * @api private
 */
var exportPersonalData = module.exports.exportPersonalData = function(restCtx, userId, exportType, callback) {
    var url = '/api/user/' + RestUtil.encodeURIComponent(userId) + '/export/' + RestUtil.encodeURIComponent(exportType);
    RestUtil.RestRequest(restCtx, url, 'GET', {}, callback);
};
