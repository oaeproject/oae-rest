...
const CropAPI = require('./api.crop');
 ...
 * @api private
 */
const _createTenantAdminUser = function(
  restCtx,
  tenantAlias,
  username,
  password,
...
const exportPersonalData = function(restCtx, userId, exportType, callback) {
  const url =
    ...
    '/export/' +
    RestUtil.encodeURIComponent(exportType);
  RestUtil.performRestRequest(restCtx, url, 'GET', {}, callback);
};
