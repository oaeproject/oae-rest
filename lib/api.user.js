 ...
 */
const createGlobalAdminUser = (restCtx, username, password, displayName, email, opts, callback) => {
  opts = _.extend({}, opts, {
    username,
    password,
    displayName,
  ...
  RestUtil.performRestRequest(restCtx, '/api/user/createGlobalAdminUser', 'POST', opts, callback);
};
 ...
 * @api private
 */
const _createTenantAdminUser = function(restCtx, tenantAlias, username, password, displayName, email, opts, callback) {
  opts = opts || {};
  const params = _.extend({}, opts, {
    username,
    password,
    displayName,
    email
 ...
 * @param  {User}           callback.user   The user object that was created
 */
const createTenantAdminUser = (restCtx, username, password, displayName, email, opts, callback) => {
 ...
 * @param  {User}           callback.user   The user object that was created
 */
const createTenantAdminUserOnTenant = (
  restCtx,
  tenantAlias,
  username,
  password,
 ...
 * @api private
 */
const _createUser = function(restCtx, tenantAlias, username, password, displayName, email, opts, callback) {
  opts = opts || {};
  const params = _.extend({}, opts, {
    username,
    password,
 ...
 * @param  {User}           callback.response   A User object representing the created user
 */
const createUser = (restCtx, username, password, displayName, email, opts, callback) => {
...
const deleteUser = (restCtx, userId, callback) => {
  RestUtil.performRestRequest(restCtx, '/api/user/' + RestUtil.encodeURIComponent(userId), 'DELETE', null, callback);
};
 ...
 * @param  {User}           callback.response   A User object representing the created user
 */
const createUserOnTenant = (restCtx, tenantAlias, username, password, displayName, email, opts, callback) => {
...
const getMe = (restCtx, callback) => {
  RestUtil.performRestRequest(restCtx, '/api/me', 'GET', null, callback);
};
...
const getUser = (restCtx, userId, callback) => {
  RestUtil.performRestRequest(restCtx, '/api/user/' + RestUtil.encodeURIComponent(userId), 'GET', null, callback);
};
 ...
 * @param  {Object}          callback.err    Standard error object, if any
 */
const updateUser = (restCtx, userId, params, callback) => {
  RestUtil.performRestRequest(restCtx, '/api/user/' + RestUtil.encodeURIComponent(userId), 'POST', params, callback);
};
...
const getTimezones = (restCtx, callback) => {
  RestUtil.performRestRequest(restCtx, '/api/timezones', 'GET', null, callback);
};
...
const getTermsAndConditions = (restCtx, locale, callback) => {
  RestUtil.performRestRequest(restCtx, '/api/user/termsAndConditions', 'GET', { locale }, callback);
};
...
const acceptTermsAndConditions = (restCtx, userId, callback) => {
  ...
  RestUtil.performRestRequest(restCtx, url, 'POST', {}, callback);
};
...
const verifyEmail = (restCtx, userId, token, callback) => {
  ...
  RestUtil.performRestRequest(restCtx, url, 'POST', { token }, callback);
};
...
const deleteEmailToken = (restCtx, userId, callback) => {
  const url = '/api/user/' + RestUtil.encodeURIComponent(userId) + '/email/token';
  RestUtil.performRestRequest(restCtx, url, 'DELETE', {}, callback);
};
 ...
 * @api private
 */
const exportPersonalData = function(restCtx, userId, exportType, callback) {
