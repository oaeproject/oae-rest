 ...
 */
var createGlobalAdminUser = (module.exports.createGlobalAdminUser = function(
    restCtx,
    username,
    password,
    displayName,
    ...
    RestUtil.RestRequest(
        restCtx,
        '/api/user/createGlobalAdminUser',
        'POST',
        opts,
        callback,
    );
 ...
 * @param  {User}           callback.user   The user object that was created
 */
var createTenantAdminUserOnTenant = (module.exports.createTenantAdminUserOnTenant = function(
    restCtx,
    tenantAlias,
    username,
    password,
 ...
 * @param  {Object}         callback.err    An error that occurred, if any
 */
var deleteUser = (module.exports.deleteUser = function(
    restCtx,
    userId,
    callback,
) {
 ...
 * @param  {User}           callback.response   A User object representing the created user
 */
var createUserOnTenant = (module.exports.createUserOnTenant = function(
    restCtx,
    tenantAlias,
    username,
    password,
 ...
 */
var uploadPicture = (module.exports.uploadPicture = function(
    restCtx,
    userId,
    file,
    selectedArea,
 ...
 */
var downloadPicture = (module.exports.downloadPicture = function(
    restCtx,
    userId,
    size,
    callback,
...
var verifyEmail = (module.exports.verifyEmail = function(
    ...
    var url =
        '/api/user/' + RestUtil.encodeURIComponent(userId) + '/email/verify';
...
var resendEmailToken = (module.exports.resendEmailToken = function(
    ...
    var url =
        '/api/user/' + RestUtil.encodeURIComponent(userId) + '/email/resend';
    RestUtil.RestRequest(restCtx, url, 'POST', {}, callback);
});
...
var getEmailToken = (module.exports.getEmailToken = function(
    ...
    var url =
        '/api/user/' + RestUtil.encodeURIComponent(userId) + '/email/token';
 ...
 */
var getRecentlyVisitedGroups = (module.exports.getRecentlyVisitedGroups = function(
    restCtx,
    userId,
    callback,
) {
    var url =
        '/api/user/' + RestUtil.encodeURIComponent(userId) + '/groups/recent';
    RestUtil.RestRequest(restCtx, url, 'GET', {}, callback);
});
 ...
 * @api private
 */
var _createTenantAdminUser = function(
    restCtx,
    tenantAlias,
    username,
    password,
...
var _createUser = function(
    ...
    if (tenantAlias) {
        url =
            '/api/user/' + RestUtil.encodeURIComponent(tenantAlias) + '/create';
    }
    RestUtil.RestRequest(restCtx, url, 'POST', params, callback);
};
