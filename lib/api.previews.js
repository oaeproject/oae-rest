...
const reprocessPreviews = (globalAdminRestContext, filters, callback) => {
  RestUtil.performRestRequest(globalAdminRestContext, '/api/content/reprocessPreviews', 'POST', filters, callback);
};
...
const expandUrl = (restCtx, url, callback) => {
  ...
  RestUtil.performRestRequest(restCtx, '/api/longurl/expand', 'GET', data, callback);
};
