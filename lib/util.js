 ...
 */
var RestRequest = (module.exports.RestRequest = function(
    restCtx,
    url,
    method,
    data,
 ...
 */
var fillCookieJar = (module.exports.fillCookieJar = function(
    restCtx,
    callback,
) {
...
var _RestRequest = function(restCtx, url, method, data, callback) {
    ...
    if (_.isObject(restCtx.additionalHeaders)) {
        requestOpts.headers = _.extend(
            requestOpts.headers,
            restCtx.additionalHeaders,
        );
    }
