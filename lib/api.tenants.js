 ...
 *
 * @param  {RestContext}    restCtx             Standard REST Context object that contains the current tenant URL and the current user credentials. In order for this to work, a global admin rest context will need to passed in.
 * @param  {Number}         start               The index to start paging from
 * @param  {Number}         limit               The maximum number of results to return
 * @param  {String}         q                   Query string used for filtering the results
 ...
 */
var getTenants = module.exports.getTenants = function(restCtx, start, limit, q, callback) {
    RestUtil.RestRequest(restCtx, '/api/tenants', 'GET', {'start': start, 'limit': limit, 'q':q}, callback);
};
