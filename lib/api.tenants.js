 ...
 */
var getTenants = module.exports.getTenants = function(restCtx, start, limit, callback) {
    RestUtil.RestRequest(restCtx, '/api/tenants', 'GET', {'start': start, 'limit': limit}, callback);
};
