...
const getSchema = (restCtx, callback) => {
  RestUtil.performRestRequest(restCtx, '/api/config/schema', 'GET', null, callback);
};
...
const updateConfig = (restCtx, tenantAlias, update, callback) => {
  ...
  RestUtil.performRestRequest(restCtx, url, 'POST', update, callback);
};
...
const clearConfig = (restCtx, tenantAlias, configFields, callback) => {
  ...
  url += '/clear';
  RestUtil.performRestRequest(restCtx, url, 'POST', { configFields }, callback);
};
