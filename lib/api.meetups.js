...
import { parseResponse, performRestRequest } from './util.js';
...
const joinMeetup = (restCtx, groupId, callback) => {
  doRequest(restCtx, `${API_ENDPOINT}/${groupId}/join`, HTTP_GET, null, parseResponse(callback));
};
...
const endMeetup = (restCtx, groupId, callback) => {
  doRequest(restCtx, `${API_ENDPOINT}/${groupId}/end`, HTTP_POST, null, parseResponse(callback));
};
...
const isMeetingRunning = (restCtx, groupId, callback) => {
  doRequest(restCtx, `${API_ENDPOINT}/${groupId}/isMeetingRunning`, HTTP_GET, null, parseResponse(callback));
};
