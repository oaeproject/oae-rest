...
const getFollowers = (restCtx, userId, start, limit, callback) => {
  RestUtil.performRestRequest(
    restCtx,
    `/api/following/${RestUtil.encodeURIComponent(userId)}/followers`,
    HTTP_GET,
    { start, limit },
    callback
  );
...
const getFollowing = (restCtx, userId, start, limit, callback) => {
  RestUtil.performRestRequest(
    restCtx,
    `/api/following/${RestUtil.encodeURIComponent(userId)}/following`,
    HTTP_GET,
    { start, limit },
    callback
  );
...
const follow = (restCtx, userId, callback) => {
  RestUtil.performRestRequest(
    restCtx,
    `/api/following/${RestUtil.encodeURIComponent(userId)}/follow`,
    HTTP_POST,
    null,
    callback
  );
...
const unfollow = (restCtx, userId, callback) => {
  RestUtil.performRestRequest(
    restCtx,
    `/api/following/${RestUtil.encodeURIComponent(userId)}/unfollow`,
    HTTP_POST,
    null,
    callback
  );
