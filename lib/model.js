 ...
 */
export const RestContext = function (host, options) {
  const that = {};
  ...
  that.userPassword = options.userPassword;
  that.hostHeader = options.hostHeader;
  that.refererHeader = options.refererHeader;
  that.additionalHeaders = options.additionalHeaders;
  that.cookieJar = null;
  that.strictSSL = options.strictSSL !== false;
  that.followRedirect = options.followRedirect !== false;
