 ...
 */
const search = (restCtx, searchType, params, opts, callback) => {
  params = params || [];
  opts = opts || {};
  ...
  RestUtil.performRestRequest(restCtx, path, 'GET', opts, callback);
};
...
const refresh = (restCtx, callback) => {
  RestUtil.performRestRequest(restCtx, '/api/search/_refresh', 'POST', null, callback);
};
...
const reindexAll = (globalAdminRestCtx, callback) => {
  RestUtil.performRestRequest(globalAdminRestCtx, '/api/search/reindexAll', 'POST', null, callback);
};
