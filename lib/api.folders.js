...
const getFolder = (restCtx, folderId, callback) => {
  RestUtil.performRestRequest(restCtx, '/api/folder/' + RestUtil.encodeURIComponent(folderId), 'GET', null, callback);
};
...
const createFolder = (restCtx, displayName, description, visibility, managers, viewers, callback) => {
  ...
  RestUtil.performRestRequest(restCtx, '/api/folder', 'POST', params, callback);
};
...
const updateFolder = (restCtx, folderId, updates, callback) => {
  RestUtil.performRestRequest(
    restCtx,
    '/api/folder/' + RestUtil.encodeURIComponent(folderId),
    'POST',
    updates,
    callback
  );
...
const updateFolderContentVisibility = (restCtx, folderId, visibility, callback) => {
  ...
  const url = '/api/folder/' + RestUtil.encodeURIComponent(folderId) + '/contentvisibility';
...
const shareFolder = (restCtx, folderId, principalIds, callback) => {
  RestUtil.performRestRequest(
    restCtx,
    '/api/folder/' + RestUtil.encodeURIComponent(folderId) + '/share',
    'POST',
...
const updateFolderMembers = (restCtx, folderId, memberUpdates, callback) => {
  RestUtil.performRestRequest(
    restCtx,
    '/api/folder/' + RestUtil.encodeURIComponent(folderId) + '/members',
    'POST',
    memberUpdates,
    callback
  );
...
const getFoldersLibrary = (restCtx, principalId, start, limit, callback) => {
  ...
  RestUtil.performRestRequest(
    restCtx,
    '/api/folder/library/' + RestUtil.encodeURIComponent(principalId),
    'GET',
    params,
    callback
  );
...
const getManagedFolders = (restCtx, callback) => {
  RestUtil.performRestRequest(restCtx, '/api/folder/managed', 'GET', null, callback);
};
...
const addContentItemsToFolder = (restCtx, folderId, contentIds, callback) => {
  RestUtil.performRestRequest(
    restCtx,
    '/api/folder/' + RestUtil.encodeURIComponent(folderId) + '/library',
    'POST',
    { contentIds },
    callback
  );
...
const createMessage = (restCtx, folderId, body, replyTo, callback) => {
  ...
  RestUtil.performRestRequest(
    restCtx,
    '/api/folder/' + RestUtil.encodeURIComponent(folderId) + '/messages',
    'POST',
    params,
    callback
  );
...
const deleteMessage = (restCtx, folderId, messageCreated, callback) => {
  RestUtil.performRestRequest(
    restCtx,
    '/api/folder/' + RestUtil.encodeURIComponent(folderId) + '/messages/' + RestUtil.encodeURIComponent(messageCreated),
    'DELETE',
    null,
    callback
  );
