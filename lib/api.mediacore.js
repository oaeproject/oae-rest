 ...
 * @param  {Object}         callback.err        Error object containing error code and error message
 */
const notifyEncodingComplete = (restCtx, mediaCoreId, callback) => {
  ...
  RestUtil.performRestRequest(restCtx, '/api/mediacore/encodingCallback', 'POST', { mediaId: mediaCoreId }, callback);
};
