 ...
 */
var getEmbedCode = (module.exports.getEmbedCode = function(
    restCtx,
    contentId,
    callback,
) {
 ...
 * @param  {Object}         callback.err        Error object containing error code and error message
 */
var notifyEncodingComplete = (module.exports.notifyEncodingComplete = function(
    restCtx,
    mediaCoreId,
    callback,
) {
    ...
    RestUtil.RestRequest(
        restCtx,
        '/api/mediacore/encodingCallback',
        'POST',
        { media_id: mediaCoreId },
        callback,
    );
});
