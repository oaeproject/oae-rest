 ...
 */
var getSignedTenantAuthenticationRequestInfo = (module.exports.getSignedTenantAuthenticationRequestInfo = function(
    globalAdminRestCtx,
    tenantAlias,
    callback,
) {
 ...
 */
var getSignedBecomeUserAuthenticationRequestInfo = (module.exports.getSignedBecomeUserAuthenticationRequestInfo = function(
    adminRestCtx,
    becomeUserId,
    callback,
) {
 ...
 * @param  {Object}         callback.err    An error that occurred, if any
 */
var doSignedAuthentication = (module.exports.doSignedAuthentication = function(
    restCtx,
    body,
    callback,
) {
    RestUtil.RestRequest(restCtx, '/api/auth/signed', 'POST', body, function(
        err,
        body,
        response,
    ) {
 ...
 */
var loginAsUser = (module.exports.loginAsUser = function(
    adminRestCtx,
    becomeUserId,
 ...
 */
var loginOnTenant = (module.exports.loginOnTenant = function(
    globalAdminRestCtx,
    tenantAlias,
    targetInternalBaseUrl,
    callback,
...
var getAllUsersForTenant = (module.exports.getAllUsersForTenant = function(
    ...
    var url =
        '/api/tenants/' + RestUtil.encodeURIComponent(tenantAlias) + '/users';
 ...
 * @api private
 */
var _doSignedAuthenticationWithRequestInfo = function(
    requestInfo,
    internalBaseUrl,
    strictSSL,
    callback,
    ...
    var baseUrl =
        internalBaseUrl ||
        util.format('%s//%s', parsedUrl.protocol, parsedUrl.host);
    var authenticatingRestCtx = new RestContext(baseUrl, {
        hostHeader: parsedUrl.host,
        strictSSL: strictSSL,
    });
    doSignedAuthentication(authenticatingRestCtx, requestInfo.body, function(
        err,
    ) {
        if (err) {
            return callback(err);
