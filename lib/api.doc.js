...
const getModules = (restCtx, type, callback) => {
  RestUtil.performRestRequest(restCtx, '/api/doc/' + RestUtil.encodeURIComponent(type), 'GET', null, callback);
};
...
const getSwaggerResources = (restCtx, callback) => {
  RestUtil.performRestRequest(restCtx, '/api/swagger', 'GET', null, callback);
};
...
const getSwaggerApi = (restCtx, id, callback) => {
  RestUtil.performRestRequest(restCtx, '/api/swagger/' + id, 'GET', null, callback);
};
