 ...
 */
var getModules = (module.exports.getModules = function(
    restCtx,
    type,
    callback,
) {
...
var getModuleDocumentation = (module.exports.getModuleDocumentation = function(
    ...
    RestUtil.RestRequest(
        restCtx,
        '/api/doc/' +
            RestUtil.encodeURIComponent(type) +
            '/' +
            RestUtil.encodeURIComponent(moduleId),
        'GET',
        null,
        callback,
    );
 ...
 */
var getSwaggerResources = (module.exports.getSwaggerResources = function(
    restCtx,
    callback,
) {
 ...
 */
var getSwaggerApi = (module.exports.getSwaggerApi = function(
    restCtx,
    id,
    callback,
) {
