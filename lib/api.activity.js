...
const getCurrentUserActivityStream = (restCtx, opts, callback) => {
  RestUtil.performRestRequest(restCtx, '/api/activity', 'GET', opts, callback);
};
...
const getActivityStream = (restCtx, activityStreamId, opts, callback) => {
  RestUtil.performRestRequest(
    restCtx,
    '/api/activity/' + RestUtil.encodeURIComponent(activityStreamId),
    'GET',
    opts,
    callback
  );
...
const getNotificationStream = (restCtx, opts, callback) => {
  RestUtil.performRestRequest(restCtx, '/api/notifications', 'GET', opts, callback);
};
...
const markNotificationsRead = (restCtx, callback) => {
  RestUtil.performRestRequest(restCtx, '/api/notifications/markRead', 'POST', null, callback);
};
...
const collect = (restCtx, callback) => {
  RestUtil.performRestRequest(restCtx, '/api/activity/collect', 'POST', null, callback);
};
